...
class TrackTime:
    ...
    def initial_sync(self):
        # Keep sending timesync requests until the delta buffer is full
...
print("Initial timesync jitter (standard deviation of delta buffer): {} ms, {}% of average latency".format(stddev, jitterpercent))
if jitterpercent > 20:
    log.info("WARNING: Timesync jitter is VERY high. This will signficantly affect video frame -> inertial frame correlation.")
    print("WARNING: Timesync jitter is VERY high. This will signficantly affect video frame -> inertial frame correlation.")

# Set some parameters important to precision landing
log.info("Setting flight controller parameters")
print("Setting flight controller parameters")
...
while True:
    ...
    if not line:
        ...
        if search("^error:", line):
            ...
            print("track_targets: "+sub("^error:","",line))
...
while True:
    ...
    if track_targets.process.returncode != None and track_targets.shutdown:
        ...
        print("Tracking process return code:"+str(track_targets.process.returncode)+", exiting main loop")
        break
        ...
        print("Error: Tracking process shut down unexpectedly ("+str(track_targets.process.returncode)+"), restarting")
        track_targets = TrackTargets(args, calibration)
...
print("Vision_landing shutdown complete, exiting")
